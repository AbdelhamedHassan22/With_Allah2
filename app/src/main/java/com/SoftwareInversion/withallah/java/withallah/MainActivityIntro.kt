...
class MainActivityIntro : AppCompatActivity(), View.OnClickListener {

    lateinit var mpager:ViewPager
var layouts:IntArray= intArrayOf(R.layout.first_slider, R.layout.second_slider,R.layout.third_slider)
...
/*
        ...
        btn_start.setOnClickListener {
            startActivity(Intent(this,DoaaFragment::class.java))
            finish()
